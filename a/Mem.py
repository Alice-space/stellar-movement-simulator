...
ta output.
    ...
    Or if you want to get a more organized result, try the following.
...
def getcurrentobjects():
    ''' Get all objects to draw the 3D world. (A trivial function) '''
...
def reinitialize():
    ''' Clear the database by removing all the data in it. (A trivial function)
'''

    global objects, lennum, objnum, t0, totalorder
